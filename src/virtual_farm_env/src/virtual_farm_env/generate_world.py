...
from virtual_farm_env import world_generator
from virtual_farm_env.world_generator.field_2d_generator import Field2DGenerator
from virtual_farm_env.world_generator.world_description import WorldDescription
...
class WorldGenerator:
    def __init__(self, **kwargs) -> None:
        ...
        self.cache_folder = Path(_ros_home_path) / "virtual_farm_env"
    ...
    def generate_sdf(self) -> None:
        ...
        # Save heightmap
        heightmap_file = self.cache_folder / "virtual_farm_env_heightmap.png"
    ...
    def clear_gazebo_cache(self) -> None:
        ...
        """
        gazebo_cache_pkg = Path.home() / ".gazebo/paging/virtual_farm_env_heightmap"
...
def main() -> None:
    ...
    pkg_path = Path(rospkg.RosPack().get_path("virtual_farm_env"))
